/*
  ...
  gengetopt -i graphSim.ggo --file-name=graphSim_cmdline --include-getopt --default-optional --unamed-opts
...
const char *gengetopt_args_info_purpose = "Graph simulation tool";

const char *gengetopt_args_info_usage = "Usage: graphSim [OPTIONS]... [FILES]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -v, --verbose-lvl=INT    Level of verbosity (0 = nothing, 3 = full)  \n                             (default=`0')",
  ...
  "      --all-len=INT        Maximal length of paths  (default=`8')",
  "\nSimulation:",
  "      --simulate           Simulate? (simulates from all-from to all-to)  \n                             (default=off)",
  "      --sim-len=INT        Maximal length of simulation  (default=`10000')",
  "      --sim-cnt=INT        Number of simulated trajectories  (default=`1000')",
  "      --sim-print-len=INT  Number of best paths to print (-1 means all of them) \n                              (default=`-1')",
    0
};
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->sim_len_given = 0 ;
  args_info->sim_cnt_given = 0 ;
  args_info->sim_print_len_given = 0 ;
}
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->all_len_arg = 8;
  args_info->all_len_orig = NULL;
  args_info->simulate_flag = 0;
  args_info->sim_len_arg = 10000;
  args_info->sim_len_orig = NULL;
  args_info->sim_cnt_arg = 1000;
  args_info->sim_cnt_orig = NULL;
  args_info->sim_print_len_arg = -1;
  args_info->sim_print_len_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->verbose_lvl_help = gengetopt_args_info_help[2] ;
  args_info->rates_help = gengetopt_args_info_help[3] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->sim_len_orig));
  free_string_field (&(args_info->sim_cnt_orig));
  free_string_field (&(args_info->sim_print_len_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->all_to_given)
    write_into_file(outfile, "all-to", args_info->all_to_orig, 0);
  if (args_info->all_len_given)
    write_into_file(outfile, "all-len", args_info->all_len_orig, 0);
  if (args_info->simulate_given)
    write_into_file(outfile, "simulate", 0, 0 );
  if (args_info->sim_len_given)
    write_into_file(outfile, "sim-len", args_info->sim_len_orig, 0);
  if (args_info->sim_cnt_given)
    write_into_file(outfile, "sim-cnt", args_info->sim_cnt_orig, 0);
  if (args_info->sim_print_len_given)
    write_into_file(outfile, "sim-print-len", args_info->sim_print_len_orig, 0);
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'v':	/* Level of verbosity (0 = nothing, 3 = full).  */
        ...
        case 'r':	/* Create rates for treekin.  */
          ...
          break;
        case 'f':	/* File where to write rates.  */
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "print-graph") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->print_graph_flag), 0, &(args_info->print_graph_given),
                &(local_args_info.print_graph_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "print-graph", '-',
                additional_error))
              goto failure;
          
          }
          /* Generate dot file?.  */
          else if (strcmp (long_options[option_index].name, "dot-print") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->dot_print_flag), 0, &(args_info->dot_print_given),
                &(local_args_info.dot_print_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "dot-print", '-',
                additional_error))
              goto failure;
          
          }
          /* Generate also neato file from dot output? (forces dot-print).  */
          else if (strcmp (long_options[option_index].name, "dot-graph") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->dot_graph_flag), 0, &(args_info->dot_graph_given),
                &(local_args_info.dot_graph_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "dot-graph", '-',
                additional_error))
              goto failure;
          
          }
          /* Maximal number of sequences in graph (0=infty).  */
          else if (strcmp (long_options[option_index].name, "dot-threshold") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->dot_threshold_arg), 
                 &(args_info->dot_threshold_orig), &(args_info->dot_threshold_given),
          ...
          /* Construct all paths from node number\n(all-to must be specified too).  */
          else if (strcmp (long_options[option_index].name, "all-from") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->all_from_arg), 
                 &(args_info->all_from_orig), &(args_info->all_from_given),
                &(local_args_info.all_from_given), optarg, 0, "0", ARG_INT,
                check_ambiguity, override, 0, 0,
                "all-from", '-',
                additional_error))
              goto failure;
          ...
          /* Construct all paths to node number.  */
          else if (strcmp (long_options[option_index].name, "all-to") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->all_to_arg), 
                 &(args_info->all_to_orig), &(args_info->all_to_given),
                &(local_args_info.all_to_given), optarg, 0, 0, ARG_INT,
                check_ambiguity, override, 0, 0,
                "all-to", '-',
                additional_error))
              goto failure;
          ...
          /* Maximal length of paths.  */
          else if (strcmp (long_options[option_index].name, "all-len") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->all_len_arg), 
                 &(args_info->all_len_orig), &(args_info->all_len_given),
                &(local_args_info.all_len_given), optarg, 0, "8", ARG_INT,
                check_ambiguity, override, 0, 0,
                "all-len", '-',
                additional_error))
              goto failure;
          ...
          /* Simulate? (simulates from all-from to all-to).  */
          ...
          /* Maximal length of simulation.  */
          else if (strcmp (long_options[option_index].name, "sim-len") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->sim_len_arg), 
                 &(args_info->sim_len_orig), &(args_info->sim_len_given),
                &(local_args_info.sim_len_given), optarg, 0, "10000", ARG_INT,
                check_ambiguity, override, 0, 0,
                "sim-len", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "sim-cnt") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->sim_cnt_arg), 
                 &(args_info->sim_cnt_orig), &(args_info->sim_cnt_given),
                &(local_args_info.sim_cnt_given), optarg, 0, "1000", ARG_INT,
                check_ambiguity, override, 0, 0,
                "sim-cnt", '-',
                additional_error))
              goto failure;
          ...
          /* Number of best paths to print (-1 means all of them).  */
          else if (strcmp (long_options[option_index].name, "sim-print-len") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->sim_print_len_arg), 
                 &(args_info->sim_print_len_orig), &(args_info->sim_print_len_given),
                &(local_args_info.sim_print_len_given), optarg, 0, "-1", ARG_INT,
                check_ambiguity, override, 0, 0,
                "sim-print-len", '-',
                additional_error))
              goto failure;
